//Retrieve Weather Data for Soda Springs
let weatherRequest = new XMLHttpRequest();
let urlAPI = "https://api.openweathermap.org/data/2.5/weather?id=5607916&units=imperial&APPID=32ce786d771502f613dab8cc67d41526";
weatherRequest.open('GET', urlAPI, true);
weatherRequest.send();

//Retrieve Forcast Data for Soda Springs
let weatherForecast = new XMLHttpRequest
weatherForecast.open('GET', "https://api.openweathermap.org/data/2.5/forecast?id=5607916&appid=32ce786d771502f613dab8cc67d41526&units=imperial", true);
...
function showData(jsonObj) {
    ...
    for (let i = 0; i < data.length; i++) {
        ...
        myPhoto.src = "images/gyser.jfif"
        myPhoto.setAttribute('class', 'image');
        myPhoto.setAttribute('alt', 'Napoleon');
